Nel caso in cui il dominio non contenga in sé vincoli è preferibile optare per un'altra tecnica cioè la generazione di tutte le variabili solo per i sottoinsiemi di 2 variabili, a coppie.
